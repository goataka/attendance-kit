...
export class SpecKitStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: SpecKitStackProps) {
    ...
    cdk.Tags.of(this.clockTable).add('Project', 'spec-kit');
    ...
    new cdk.CfnOutput(this, 'GSIName', {
      ...
      exportName: `SpecKit-${environment.charAt(0).toUpperCase() + environment.slice(1)}-GSIName`,
    });

    new cdk.CfnOutput(this, 'Environment', {
      value: environment,
      description: 'Deployment environment',
      exportName: `SpecKit-${environment.charAt(0).toUpperCase() + environment.slice(1)}-Environment`,
    });
