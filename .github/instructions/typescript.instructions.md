...
{
  "scripts": {
    "start:local-db": "npm run deploy:local-db -w @attendance-kit/infrastructure-deploy",
...
```json
{
  "scripts": {
    ...
    "pretest:integration": "npm run deploy:local-db -w @attendance-kit/infrastructure-deploy"
  }
}
```
