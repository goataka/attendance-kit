...
**注意**: GitHub Copilotはサービスであり、ユーザーアカウントではありません。
アサインが失敗する場合は、代わりにチームメンバーのユーザー名を使用するか、
手動でIssueをアサインすることをお勧めします。

アサイン先を変更する場合は、ワークフロー内の以下の行を編集してください：
